...
import { Avatar, Text } from "@whop/react/components";
import { Breadcrumbs } from "./Breadcrumbs";
import { NavLinks } from "./NavLinks";

/** App frame: Frosted topbar + rail + stage. */
    ...
    <div className="shell">
      <header className="topbar">
        <Link href="/" className="brand">
          ...
          <span className="wordmark">circuit</span>
        </Link>
        <Breadcrumbs />
      </header>
      ...
      <aside className="rail">
        <NavLinks />
        <div className="rail-foot between" style={{ justifyContent: "flex-start", gap: 10 }}>
          <Avatar size="2" fallback="N" color="blue" />
